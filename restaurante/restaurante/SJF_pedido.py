...
class Pedido:
    ...
    def __lt__(self, other):
        return self.tempo_preparo < other.tempo_preparo  # PriorityQueue -- colcoando prioridade no tempo de preparo
...
#        self.fila_pedidos.put((pedido.tempo_preparo, pedido))  # usa o tempo como prioridade
#
## Classe Cozinheiro
...
#    def run(self):
#        while True:
#            prioridade_pedido = self.fila_pedidos.get()
#            if prioridade_pedido is None:
#                break
#            _, pedido = prioridade_pedido
